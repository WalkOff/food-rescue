...
donors = [
    ...
    Donor(name = "Big Burrito Catering", phone="4044466348", email="jenny@niche.com@gmail.com", address = Address(address1="5740 Baum Blvd", address2 = "#2", city="Pittsburgh", state="PA", zipcode="15206")),
